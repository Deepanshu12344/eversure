...
const ProductCategories = () => {
  ...
  return (
    <section id="products" className="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-cyan-50/20 relative overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900">Our Product Portfolio</h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mt-4">
            Browse our complete range of medical devices.
          </p>
        </div>
        ...
        <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
          <input
            ...
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="px-4 py-2 border border-gray-300 rounded-lg w-full max-w-sm text-sm"
          />
          ...
          {filteredProducts.map((product) => (
            <ProductCard
              ...
              product={{
                ...
                certifications: ['ISO 9001', 'CE Certified'] // optional
              }}
              viewMode={viewMode}
            />
          ))}
